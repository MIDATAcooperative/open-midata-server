...
public class Rights {
	...
	static {
		...
		role(UserRole.MEMBER, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "security", "status", "visualizations", "zip", "birthday", "midataID", "news", "partInterest", "ssn", "language");
		role(UserRole.RESEARCH, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "security", "status", "visualizations", "zip", "midataID", "language"); // TODO Remove midataID 
		role(UserRole.PROVIDER, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "security", "status", "visualizations", "zip", "midataID", "language"); // TODO Remove midataID
		role(UserRole.DEVELOPER, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "security", "status", "visualizations", "zip", "midataID", "language"); // TODO Remove midataID
		role(UserRole.ADMIN, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "security", "status", "visualizations", "zip", "midataID", "language"); // TODO Remove midataID
