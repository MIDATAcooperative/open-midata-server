...
public class Rights {
	...
	static {
		...
		role(UserRole.ADMIN, "_id", "address1", "address2", "city", "contractStatus", "country", "email", "emailLC", "firstname", "gender", "history", "lastname", "login", "mobile", "name", "phone", "registeredAt", "role", "subroles", "security", "status", "zip", "midataID", "birthday", "confirmationCode", "emailStatus");
		role(UserRole.PROVIDER, "_id", "address1", "address2", "city", "contractStatus", "country", "email", "emailLC", "firstname", "gender", "lastname", "login", "mobile", "name", "phone", "role", "subroles", "status", "zip", "midataID", "birthday");
		...
		role(UserRole.MEMBER, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "subroles", "security", "status", "visualizations", "zip", "birthday", "midataID", "news", "partInterest", "ssn", "language", "searchable");
		role(UserRole.RESEARCH, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "subroles", "security", "status", "visualizations", "zip", "midataID", "language", "searchable"); // TODO Remove midataID 
		role(UserRole.PROVIDER, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "subroles", "security", "status", "visualizations", "zip", "midataID", "language", "searchable"); // TODO Remove midataID
		role(UserRole.DEVELOPER, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "subroles", "security", "status", "visualizations", "zip", "midataID", "language", "searchable"); // TODO Remove midataID
		role(UserRole.ADMIN, "_id", "address1", "address2", "apps", "city", "contractStatus", "country", "email", "firstname", "name", "lastname", "gender", "history", "login", "messages", "mobile", "phone", "registeredAt", "role", "subroles", "security", "status", "visualizations", "zip", "midataID", "language", "searchable"); // TODO Remove midataID
