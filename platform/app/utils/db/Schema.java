...
public class Schema {
	...
	public static void init() {
	    ...
	    DBLayer.setCollectionsForDatabase(DBLayer.DB_ACCESS, new String[] {"circles", "spaces", "participation", "keys", "keysext", "keyrecover", "keyprocess", "futurelogins", "consents", "groupmember", "auditevents", "subscriptions"});
	}
}
