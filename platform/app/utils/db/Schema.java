...
public class Schema {
	...
	public static void init() {
	    DBLayer.setCollectionsForDatabase(DBLayer.DB_USER, new String[] {"users", "researchusers", "hpusers", "admins", "providers", "memberkeys", "research", "studykeywords", "tags", "apps", "visualizations", "news", "studies", "codes", "formats"});
