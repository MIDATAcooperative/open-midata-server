...
private Feature next;
	...
	/*
	static class IdListFilter extends ProcessingTools.FilterIterator<DBRecord> {
	...
	*/
    ...
    class IndexIterator extends MultiSource<Map.Entry<MidataId, Set<MidataId>>> {

    	private Query q;
    	private Set<String> queryFields;
    	
    	IndexIterator(Query q, Iterator<Map.Entry<MidataId, Set<MidataId>>> in) throws AppException {
    		this.q = q;
    		this.query = q;
		...
		@Override
		public Iterator<DBRecord> advance(Entry<MidataId, Set<MidataId>> entry) throws AppException {
			MidataId aps = entry.getKey();
			List<DBRecord> result = Collections.emptyList();
			   AccessLog.log("Now processing aps:"+aps.toString());
