...
.controller('AuditLogCtrl', ['$scope', '$state', 'views', 'status', 'users', 'administration', 'paginationService', 'session', function($scope, $state, views, status, users, administration, paginationService, session) {
