...
.controller('AppMessagesCtrl', ['$scope', '$state', 'server', 'apps', 'status', 'languages', function($scope, $state, server, apps, status, languages) {
    ...
    $scope.tags = {
    	...
    	'CONSENT_CONFIRM_OWNER' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "consent-name", "firstname", "lastname", "email", "plugin-name", "midata-portal-url", "confirm-url"],
