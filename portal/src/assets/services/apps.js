...
.factory('apps', ['server', '$q', 'session', '$filter', function(server, $q, session, $filter) {
	...
	service.userfeatures = ['EMAIL_ENTERED', 'EMAIL_VERIFIED', 'PHONE_ENTERED', 'PHONE_VERIFIED', 'ADDRESS_ENTERED' ,'ADDRESS_VERIFIED', 'PASSPORT_VERIFIED', 'MIDATA_COOPERATIVE_MEMBER'];
