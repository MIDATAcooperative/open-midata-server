            ...
            <div v-if="!selection">
                ...
                <table class="table table-striped table-hover" v-if="links.length">
                    ...
                    <tr v-for="link in links" :key="link._id">
                        ...
                        <td>
                            <button type="button" class="btn btn-sm btn-default" @click="select(link);" v-t="'studyactions.select_btn'"></button>
                            <button type="button" class="btn btn-sm btn-default" :disabled="action!=null" @click="validate(link);" v-t="'studyactions.validate_btn'"></button>
