...
export default {
    data: () => ({	
        ...
        tags : {
            ...
            'CONSENT_REQUEST_OWNER_EXISTING' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name", "firstname", "lastname", "email", "plugin-name", "midata-portal-url", "confirm-url"],
            'CONSENT_REQUEST_AUTHORIZED_EXISTING' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name","firstname", "lastname", "email", "plugin-name", "midata-portal-url"],
            'CONSENT_CONFIRM_OWNER' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name", "firstname", "lastname", "email", "plugin-name", "midata-portal-url"],
            'CONSENT_CONFIRM_AUTHORIZED' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name", "firstname", "lastname", "email", "plugin-name", "midata-portal-url"],
            'CONSENT_REJECT_OWNER' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name","firstname", "lastname", "email", "plugin-name", "midata-portal-url"],
            'CONSENT_REJECT_AUTHORIZED' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name", "firstname", "lastname", "email", "plugin-name", "midata-portal-url"],
            'CONSENT_REJECT_ACTIVE_AUTHORIZED' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name", "firstname", "lastname", "email", "plugin-name", "midata-portal-url"],
            'CONSENT_REQUEST_OWNER_INVITED' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-email", "consent-name", "email", "plugin-name", "midata-portal-url", "confirm-url"],
            'CONSENT_REQUEST_AUTHORIZED_INVITED' : ["executor-firstname", "executor-lastname", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-email", "grantee-email", "consent-name", "email", "plugin-name", "midata-portal-url", "reject-url"],
