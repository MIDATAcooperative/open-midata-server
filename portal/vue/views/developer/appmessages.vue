...
export default {
    data: () => ({	
        ...
        tags : {
            ...
            'CONSENT_CONFIRM_AUTHORIZED' : ["executor-firstname", "executor-lastname", "executor-name", "executor-email", "grantor-firstname", "grantor-lastname", "grantor-name", "grantor-email", "grantee-firstname", "grantee-lastname", "grantee-name", "grantee-email", "consent-name", "firstname", "lastname", "email", "plugin-name", "midata-portal-url"],
