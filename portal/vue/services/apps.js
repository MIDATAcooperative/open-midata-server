...
import server from './server';
	...
	service.userfeatures = ['EMAIL_ENTERED', 'EMAIL_VERIFIED', 'PHONE_ENTERED', 'PHONE_VERIFIED', 'AUTH2FACTOR', 'ADDRESS_ENTERED' ,'ADDRESS_VERIFIED', 'BIRTHDAY_SET', 'GENDER_SET', 'PASSPORT_VERIFIED', 'MIDATA_COOPERATIVE_MEMBER', 'ADMIN_VERIFIED'];
