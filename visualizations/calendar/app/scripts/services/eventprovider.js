...
angular.module('calendarApp')
  .factory('eventProvider', ['midataServer', function(midataServer) {
	  ...
	  scope.query = function(authToken, start, end, callback) {
		  ...
		  midataServer.getRecords(authToken, { "format" : ["fhir/Observation/Quantity", "fhir/Observation/String"], content: criteria.content, "data" : { "effectiveDateTime" : { "$gt" : new Date(start.calendar()), "$lt" : new Date(end.calendar()) } } }, ["created", "data", "content" ])
